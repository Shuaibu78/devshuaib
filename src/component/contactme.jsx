...
const ContactUs = () => {
  return (
    <section id="contact" className="mx-auto flex flex-col justify-between items-center w-full bg-gray-about py-24">
      ...
      <div className="flex justify-between items-center w-full mx-auto container my-16">
        <div className="w-5/12 flex flex-col items-start justify-evenly">
