...
const AboutMe = () => {
  return (
    <section id="about" className="mx-auto flex justify-between items-center w-full bg-gray-about py-10">
      ...
      <div className="flex items-center justify-between flex-col w-1/2 text-gray-300">
