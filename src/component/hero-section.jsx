  ...
  return (
    <section id="home" className="flex justify-center items-center pt-32 w-full bg-gray-hero">
      <div className="flex flex-col-reverse sm:flex-row items-center justify-between w-11/12 sm:w-10/12 mx-auto">
        <div className=" pt-6 sm:pt-0 flex items-center pb-24 justify-between flex-col w-11/12 sm:w-1/2">
          <div className="pb-6 sm:self-start self-center">
            <span className="text-white text-1xl md:text-2xl lg:text-3xl capitalize">hello, I'm shuaib muhammad,</span>
            <h1 className="text-gray-400 font-bold text-3xl leading-snug md:text-3xl lg:leading-tight lg:text-4xl capitalize">a frontend engineer.</h1>
          </div>
